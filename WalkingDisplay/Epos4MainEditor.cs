...
public class Epos4MainEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Set Home")) {
            // epos4Main.lifter.ActivateHomingMode();
        ...
        epos4Main.lifter.profile.position     = (int)EditorGUILayout.Slider("Position (inc)", epos4Main.lifter.profile.position, -maxPosition, maxPosition);
        ...
        using (new EditorGUILayout.HorizontalScope()) {
            using (new EditorGUILayout.VerticalScope()) {
                ...
                epos4Main.leftPedal.profile.position     = (int)EditorGUILayout.Slider("Position (inc)", epos4Main.leftPedal.profile.position, -maxPosition, maxPosition);
                ...
                EditorGUILayout.Slider("Actual Pos (inc)", epos4Main.leftSlider.actualPosition, -maxActualPosition, maxActualPosition);
                if (GUILayout.Button("Set Home")) {
                ...
                epos4Main.leftSlider.profile.position     = (int)EditorGUILayout.Slider("Position (inc)", epos4Main.leftSlider.profile.position, -maxPosition, maxPosition);
            ...
            using (new EditorGUILayout.VerticalScope()) {
                ...
                epos4Main.rightPedal.profile.position     = (int)EditorGUILayout.Slider("Position (inc)", epos4Main.rightPedal.profile.position, -maxPosition, maxPosition);
                ...
                epos4Main.rightSlider.profile.position     = (int)EditorGUILayout.Slider("Position (inc)", epos4Main.rightSlider.profile.position, -maxPosition, maxPosition);
